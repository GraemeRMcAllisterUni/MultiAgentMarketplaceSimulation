...
public class BuyerAgent extends Agent {
		...
		public void action() {
			...
			if(msg != null) {
				...
				if(msg.getContent().equals("new day")) {
					...
					//dailyActivity.addSubBehaviour(new DecidePurchase(myAgent));
	...
	public class CollectOffers extends Behaviour {
		...
		public CollectOffers(Agent a) {
			super(a);
			System.out.println(currentOffers);
			currentOffers.clear();
		}
	...
	/*public class DecidePurchase extends SequentialBehaviour {
		
		public DecidePurchase(Agent a) {
			super(a);
		}
